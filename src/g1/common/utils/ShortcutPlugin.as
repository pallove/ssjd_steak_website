		...
		public function set enabled(value:Boolean):void 
		{
			...
			if (_target != null)
			{
				if (_enabled) {
					...
					_target.addEventListener(RichTextField.MSG_APPEND, onTextChange);
				}
				else {
					_target.removeEventListener(Event.CHANGE, onTextChange);
					_target.removeEventListener(RichTextField.MSG_APPEND, onTextChange);
				}
			}
		}
	}	
